...
public class CurrentGame {
    ...
    private static final int MAX_NUM_QUESTIONS = MAX_NUM_GRADE_LEVELS * 2 + 1;
    ...
    *  making sure that the subject of each question is unique. */
    public static void generateFullGameQuestions() {
        ...
        for (int i = 0; i < MAX_NUM_QUESTIONS; i++) {
            ...
            /* Assumes Question Bank contains questions of various subjects
               for MAX_NUM_GRADE_LEVELS grade levels */
