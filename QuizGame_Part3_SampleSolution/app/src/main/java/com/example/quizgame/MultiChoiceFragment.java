    ...
    private void linkViews(View view) {
        ...
        choice1Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                choice1Button.setBackgroundColor(getResources().getColor(R.color.purple_200));
                choice2Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice3Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice4Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
        ...
        choice2Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                choice2Button.setBackgroundColor(getResources().getColor(R.color.purple_200));
                choice1Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice3Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice4Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
        ...
        choice3Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                choice3Button.setBackgroundColor(getResources().getColor(R.color.purple_200));
                choice2Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice1Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice4Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
        ...
        choice4Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                choice4Button.setBackgroundColor(getResources().getColor(R.color.purple_200));
                choice2Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice3Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
                choice1Button.setBackgroundColor(getResources().getColor(R.color.purple_500));
